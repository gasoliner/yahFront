...
<div class="header">
    <div class="nag">
        <div class="in">
            ...
            <span class="tl" style="display:">欢迎注册</span>
            <p class="nlink n2">
...
<script>
    ...
    <div class="lrbox clearfix">
        ...
        <div class="lr_rt">
            <div class="lr_h">填写会员信息</div>
            <form action="/login/registry" method="post" enctype="multipart/form-data" name="signup" id="signup" >

                <div class="lr_e">
                    <label><span class="err" style="display:none" ></span>用户名</label>
                    <div class="txt">
                        <input class="ef"  type="text" autocomplete='off'  name="name" placeholder="建议填写真实姓名，方便企业联系您"  value="" />
                ...
                <div class="lr_e">
                    ...
                    <div class="txt">
                        ...
                        <%--<span class="icon_ok" style="display:none" id="userpwd_ok"></span>--%>
                    </div>
                </div>
                <div class="lr_e">
                    <label><span class="err" style="display:none" id="pwdcfm_err"></span>确认密码</label>
                    <div class="txt">
                        <input class="ef" type="password" autocomplete='off' id="cfmpwd" name="password2" maxlength=16 placeholder="请输入和上面相同的密码" value="" />
                        <%--<span class="icon_ok" style="display:none" id="cfmpwd_ok"></span>--%>
                    </div>
                </div>
                <div class="lr_e">
                    <label><span class="err" style="display:none" ></span>联系方式</label>
                    <div class="txt">
                        <input class="ef"  type="text" autocomplete='off'  name="phone"  value="" />
                        <%--<span class="icon_ok" style="display:none" id="phone_ok"></span>--%>
                    </div>
                </div>
                <div class="lr_e">
                    ...
                    <div class="txt">
                        <input class="ef"  type="text" autocomplete='off'  name="email"  value="" />
                        <%--<span class="icon_ok" style="display:none" id="phone_ok"></span>--%>
                    </div>
                </div>
                <div class="lr_e">
                    ...
                    <div class="txt">
                        <input class="ef"  type="text" autocomplete='off'  name="age"  value="" />
                        <%--<span class="icon_ok" style="display:none" id="phone_ok"></span>--%>
                    </div>
                </div>
                <div class="lr_e">
                    ...
                    <div class="txt">
                        <input class="ef"  type="text" autocomplete='off'  name="university"  value="" />
                        <%--<span class="icon_ok" style="display:none" id="phone_ok"></span>--%>
                    </div>
                </div>
                <div class="lr_e">
                    ...
                    <div class="txt">
                        <input class="ef"  type="text" autocomplete='off'  name="point"  value="" />
                        <%--<span class="icon_ok" style="display:none" id="phone_ok"></span>--%>
                    </div>
                </div>
                <div class="lr_e">
                    <label><span class="err" style="display:none" ></span>身份证号</label>
                    <div class="txt">
                        <input class="ef"  type="text" autocomplete='off' placeholder="请符合身份证规范"  name="idnumber"  value="" />
                        <%--<span class="icon_ok" style="display:none" id="phone_ok"></span>--%>
                    </div>
                </div>
                <div class="lr_e">
                    <label><span class="err" style="display:none" ></span>上传简历</label>
                    <div class="txt">
            ...
            <div class="lr_p">
                已有You Are Hired 帐号，<a class="a2" href="${pageContext.request.contextPath}/login/login_ui">直接登录</a>
            </div>
        </div>
        <script language="javascript">
