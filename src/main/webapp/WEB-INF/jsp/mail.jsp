...
<div class="dw_wp">
    ...
    <div class="dw_table" id="resultList">
        ...
        <div class="el title">
            ...
            <span class="t2">发送者</span>
            <span class="t3">发布日期</span>
        </div>
        <c:forEach items="${mailList}" var="mail">
            <c:if test="${mail != null}">
                <div class="el">
                    <p class="t1 ">
                    <span>
                        <a target="_blank" title="${mail.name}"
                           href="${pageContext.request.contextPath}/mail/detail/${mail.maid}" onmousedown="">&nbsp;&nbsp;
                                        ${mail.name}
                        </a>
                    </span>
                    </p>
                    <span class="t2">${mail.voSender}</span>
                    <span class="t3">${mail.voPublish}</span>
                </div>
            </c:if>
        </c:forEach>
            <div class="el">
