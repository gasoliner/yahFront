...
<div class="dw_wp">
    ...
    <div class="dw_table" id="resultList">
        ...
        <div class="el title">
            <span class="t1">标题</span>
            <span class="t2">发布时间</span>
        </div>
        <c:forEach items="${interviewskillList}" var="interviewskill">

            <div class="el">
                <p class="t1 ">
                    <span>
                        <a target="_blank" title="${interviewskill.name}"
                           href="${pageContext.request.contextPath}/interviewskill/detail/${interviewskill.iid}" onmousedown="">&nbsp;&nbsp;
                                        ${interviewskill.name}
                        </a>
                    </span>
                </p>
                <span class="t2">${interviewskill.voPublish}</span>
            </div>
