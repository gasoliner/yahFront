...
<div class="tCompanyPage">
    ...
    <div class="tCompany_center clearfix">
        ...
        <div class="tHeader tHjob">
            <div class="in">
                <div class="cn">
                    <h1 align="center" title="${mail.name}">${mail.name}</h1>
                    <p class="cname">
                        发送时间： ${mail.voPublish}<em class="icon_b i_link"></em>
                    </p>
                </div>
                <div class="clear"></div>
            </div>
        ...
        <div style="width: 100%" class="tCompany_main" >
            ...
            <div class="tBorderTop_box">
                <h2>
                    <span class="bname">邮件正文</span>
                </h2>
                <div class="bmsg job_msg inbox">
                    ${mail.content}
                    <p align="right">邮件发送者：${mail.voSender}</p><br/>
                    <p align="right">邮件接收者：${mail.voReceiver}</p><br/>
                    <p align="right">发送时间：${mail.voPublish}</p>
                    <div class="clear"></div>
                </div>
            </div>
