...
<div class="tCompanyPage">
    ...
    <div class="tCompany_center clearfix">
        ...
        <div class="tHeader tHjob">
            <div class="in">
                <div class="cn">
                    <h1 align="center" title="${news.name}">${news.name}</h1>
                    <p class="cname">
                        发布时间： ${news.voPublish}<em class="icon_b i_link"></em>
                    </p>
                </div>
                <div class="clear"></div>
            </div>
        ...
        <div style="width: 100%" class="tCompany_main" >
            ...
            <div class="tBorderTop_box">
                <h2>
                    <span class="bname">站内新闻</span>
                </h2>
                <div class="bmsg job_msg inbox">
                    ${news.content}
                    <p align="right">发稿时间：${news.voPublish}</p>
                    <div class="clear"></div>
                </div>
            </div>
