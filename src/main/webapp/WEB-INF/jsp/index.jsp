...
<head>
    ...
    <title>You Are Hired_人才网_找工作_求职_上You Are Hired</title>
...
<div class="header fix" style="display: none;">
    <div class="bar">
    </div>
</div>
<!-- 首页头部搜索框结束-->
<div class="content"
     style="background:url(${pageContext.request.contextPath}/ui/mymodel/sucai/background.jpg) center no-repeat">
    <a class="c_entry" style="cursor:default"></a>
    <div class="in Fm">
        <input type="hidden" id="showguide" value="2">
        <input type="hidden" id="showlayer" value="2">
        <input type="hidden" id="language" value="c">
        <input type="hidden" id="pageCode" value="11101">

        <input type="hidden" id="userid" value="">
        <div class="ubox">
            <div class="ufm radius_5">
                <iframe name="login_iframe" id="iframe1" onload="load()" style="display:none"
                        src="../../ui/mymodel/sucai/saved_resource.html">
                </iframe>
            </div>
        </div>
...
<div class="hm container">
    ...
    <div class="blck cn">
        <strong class="tle c_orange">招聘会信息</strong>
        <div id="jobfair">
            <ul>
    ...
    <!--famous end-->
    <div style="width: 100%" class="zlck cn">
        <strong class="tle c_orange">站内新闻</strong>
        <%--<ul class="dcon">--%>
        <ul >
